...
from beancount_reds_importers.importers.fidelity import fidelity_all_account_positions_csv

fund_data = [
    ("SPAXX", "31617H102", "FIDELITY GOVERNMENT MONEY MARKET"),
    ("FTCXX", '316176106', "FIMM TAX EXEMPT PORTFOLIO: CLASS I"),
    ('VXUS', '921909768', 'VANGUARD TOTAL INTERNATIONAL STOCK INDEX FUND'),
    ("FXAIX", '315911750', "FIDELITY 500 INDEX FUND"),
...
config = {
    ...
    "column_labels_line": "Account Number,Account Name,Symbol,Description,Quantity,Last Price,Last Price Change,Current Value,Today's Gain/Loss Dollar,Today's Gain/Loss Percent,Total Gain/Loss Dollar,Total Gain/Loss Percent,Percent Of Account,Cost Basis Total,Average Cost Basis,Type",
    "header_identifier": "^Account Number,Account Name,Symbol,Description,Quantity.*",
}

# print(config)
@regtest.with_importer(fidelity_all_account_positions_csv.Importer(config))
